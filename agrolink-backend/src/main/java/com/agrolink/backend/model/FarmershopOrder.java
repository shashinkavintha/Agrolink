...
public class FarmershopOrder {
    ...
    public Profile getDriver() { return driver; }
    public void setDriver(Profile driver) { this.driver = driver; }
    ...
    public List<FarmershopOrderItem> getItems() { return items; }
    public void setItems(List<FarmershopOrderItem> items) { this.items = items; }
}
